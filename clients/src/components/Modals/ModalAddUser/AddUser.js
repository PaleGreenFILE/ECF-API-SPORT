        ...
        <div className="relative p-4 w-full max-w-lg h-full md:h-auto">
          <div className="relative bg-white rounded-lg shadow">
            ...
            <div className="p-6 text-center">
              ...
              <span className="text-lg font-semibold">Ajouter un Club</span>
              <h3 className="mb-5 text-lg font-normal text-gray-400 ">MODAL Ajouter un Club</h3>{' '}
              <button
                data-modal-toggle="popup-modal"
                type="button"
                onClick={() => addNewModal(false)}

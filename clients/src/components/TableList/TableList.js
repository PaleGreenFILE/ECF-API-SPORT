    ...
    <div className="bg-white p-10 rounded-md w-full mt-8">
      <div className=" items-center justify-between pb-2">
        ...
        <div className="flex bg-gray-50 items-center p-2 rounded-md">
          ...
          <input className="bg-gray-50 outline-none block " type="text" placeholder="Rechercher..." value={filtersearch} onChange={(e) => handleChangeSearch(e)} />
        </div>
        ...
        <div className="flex items-center justify-start">
          ...
          <p className="ml-20">Structures ={'>'} </p>
        </div>
      </div>
      {success && <div className="text-white bg-green-500 text-center px-40">{success}</div>}
      {error && <div className="text-white bg-red-600 text-center">{error}</div>}
      <div className="flex flex-col">
        <div className="overflow-x-auto sm:-mx-6 lg:-mx-8">
          <div className="py-2 inline-block min-w-full sm:px-6 lg:px-8">
            <div className="overflow-x-auto">
              {loading && <div className="text-center ">En cours de Chargement...</div>}
                      ...
                      <Tr key={item.id} className="border-b border-gray-200 hover:bg-gray-100">
                        ...
                        <Td className="py-3 px-6 text-center">
                          <div className="flex item-center justify-center">
                            ...
                            {view && <ViewUser viewUserModal={() => setViewModal(false)} />}
